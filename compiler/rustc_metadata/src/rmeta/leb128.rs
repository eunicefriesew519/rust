...
macro_rules! impl_write_unsigned_leb128 {
    ($fn_name:ident, $int_ty:ty) => {
        ...
        pub(super) fn $fn_name(
            out: &mut [u8; max_leb128_len::<$int_ty>()],
            mut value: $int_ty,
        ) -> usize {
            let mut i = 0;
...
macro_rules! impl_read_unsigned_leb128 {
    ($fn_name:ident, $int_ty:ty) => {
        #[inline]
        pub(super) fn $fn_name(decoder: &mut MemDecoder<'_>) -> $int_ty {
